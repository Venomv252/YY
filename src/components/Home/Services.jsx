...
const Services = () => {
  ...
  const toggleShowAllServices = () => {
    ...
    // Scroll to the services section when showing more services
    if (!showAllServices) {
  ...
  const programs = [
    {
      ...
      description: "Accelerate your professional development with our intensive 2-month career growth program. Gain essential skills, industry insights, and mentorship to fast-track your career success.",
      icon: (
    ...
    {
      title: "HR Management",
      description: "Gain hands-on experience in modern HR practices. Learn to build and nurture high-performing teams.",
      icon: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 11C14.2091 11 16 9.20914 16 7C16 4.79086 14.2091 3 12 3C9.79086 3 8 4.79086 8 7C8 9.20914 9.79086 11 12 11Z" 
            fill="currentColor"/>
          <path fillRule="evenodd" clipRule="evenodd" d="M4 18C4 14.6863 7.58172 12 12 12C16.4183 12 20 14.6863 20 18V20C20 20.5523 19.5523 21 19 21H5C4.44772 21 4 20.5523 4 20V18ZM18 18V19H6V18C6 15.7909 8.68629 14 12 14C15.3137 14 18 15.7909 18 18Z" 
            fill="currentColor"/>
        </svg>
      ),
      duration: "3-6 months",
